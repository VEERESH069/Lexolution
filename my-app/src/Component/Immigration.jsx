  ...
  return (
    <div className="container">
      ...
      <section className="hero7">
        ...
        <p>
          LAn immigration lawyer is like a passport to new beginnings—navigating visas, 
          green cards, and citizenship with precision and care. Whether you're chasing 
          the dream or fighting to stay, they’re the legal compass guiding you through the journey.
           Think of them as the ultimate travel agent… but for your future
        </p>
      </section>
      <div className="robot-container">
      ...
      <section className="lawyers">
        {Ilawyers.map((lawyer, index) => (
          <div key={index} className="lawyer-card6">
